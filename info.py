...
URL = "https://vjnaditabot-4f6af84a4601.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vjnaditabot-4f6af84a4601.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vjnaditabot-4f6af84a4601.herokuapp.com/".format(FQDN)
else:
    URL = "https://vjnaditabot-4f6af84a4601.herokuapp.com/".format(FQDN)
