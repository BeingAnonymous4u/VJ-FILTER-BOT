...
URL = "https://obedient-cherilynn-serveronmeg-446350fa.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://obedient-cherilynn-serveronmeg-446350fa.koyeb.app".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://obedient-cherilynn-serveronmeg-446350fa.koyeb.app/".format(FQDN)
else:
    URL = "https://obedient-cherilynn-serveronmeg-446350fa.koyeb.app/".format(FQDN)
