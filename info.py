...
URL = "slippery-tarsier-momvimaniy-a077714d.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "slippery-tarsier-momvimaniy-a077714d.koyeb.app".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "slippery-tarsier-momvimaniy-a077714d.koyeb.app/".format(FQDN)
else:
    URL = "slippery-tarsier-momvimaniy-a077714d.koyeb.app/".format(FQDN)
