...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/hdhindibackup")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6246830040 6941610925').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://wuohrgrawxne:UcK9rfimgnBQfWZU@cluster0.ypzz8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Silicon')

# Others
VERIFY = bool(environ.get('VERIFY', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'tryshort.in')
SHORTLINK_API = environ.get('SHORTLINK_API', 'e64acec306f8ef3c8c3333c8f1e0f4462dfae572')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+kstxmybhcg44ZWE1')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'iMdbChatRoom')
...
URL = "https://clever-esmeralda-vjnewrepostiry-d825cc3e.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://clever-esmeralda-vjnewrepostiry-d825cc3e.koyeb.app".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://clever-esmeralda-vjnewrepostiry-d825cc3e.koyeb.app/".format(FQDN)
else:
    URL = "https://clever-esmeralda-vjnewrepostiry-d825cc3e.koyeb.app/".format(FQDN)
