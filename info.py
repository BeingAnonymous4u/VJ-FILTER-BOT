...
URL = "https://slippery-tarsier-momvimaniy-a077714d.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://slippery-tarsier-momvimaniy-a077714d.koyeb.app".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://slippery-tarsier-momvimaniy-a077714d.koyeb.app/".format(FQDN)
else:
    URL = "https://slippery-tarsier-momvimaniy-a077714d.koyeb.app/".format(FQDN)
